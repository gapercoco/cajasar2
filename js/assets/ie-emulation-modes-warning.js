...
<html class="   ">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>bootstrap/docs/assets/js/ie-emulation-modes-warning.js at master · twbs/bootstrap</title>
...
<meta content="GitHub" property="og:site_name" /><meta content="object" property="og:type" /><meta content="https://avatars1.githubusercontent.com/u/2918581?s=400" property="og:image" /><meta content="twbs/bootstrap" property="og:title" /><meta content="https://github.com/twbs/bootstrap" property="og:url" /><meta content="bootstrap - The most popular front-end framework for developing responsive, mobile first projects on the web." property="og:description" />
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="C9EB0CC6:1EFE:A6A8575:5385FBFB" name="octolytics-dimension-request_id" /><meta content="5889706" name="octolytics-actor-id" /><meta content="gapercoco" name="octolytics-actor-login" /><meta content="780621bbf56633129c0acf91b28871d6901c20df047ce941565d3800987e0a5d" name="octolytics-actor-hash" />
...
<meta content="ZWEPvFekpGD1i04qz/WqzYut4Mksmd+qzGTBAOgH4UTvMlRcnIf7bEFh7asXrq/QQ1iYxxBw7f2HGkMBB0g+Fg==" name="csrf-token" />
...
<div class="commandbar">
  ...
  <ul id="user-links">
    <li>
      <a href="/gapercoco" class="name">
        <img alt="gapercoco" class=" js-avatar" data-user="5889706" height="20" src="https://avatars3.githubusercontent.com/u/5889706?s=140" width="20" /> gapercoco
      </a>
    </li>
...
<ul class="pagehead-actions">
    ...
    <li class="subscription">
      <form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="OeOG4XBZTGRy4HrydkfwLyyymEU475PD8Cl0h4uATKMxJkIDJK9bfUuGm2bOs+5Ppiys5DPHo1Q77w4T8Nc77g==" /></div>  <input id="repository_id" name="repository_id" type="hidden" value="2126244" />
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    ...
    <form accept-charset="UTF-8" action="/twbs/bootstrap/unstar" class="js-toggler-form starred" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="dThlGuL3MBfBSVMEuUYIzq2cNlhQkU60m9pmIyYfe3fu+/BcNhBcgdIcAwtdAxFSqHiJ181d/PHYOD1hqa6X5A==" /></div>
      <button
    ...
    <form accept-charset="UTF-8" action="/twbs/bootstrap/star" class="js-toggler-form unstarred" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="ertED4s8pD/ygRd111vyy1qBtK1bHRnQy0uMQfVmoB1jZjZDOQyYENxQ25PtN53AEC24Cshxea+gcr2343ZYCQ==" /></div>
      <button
        class="minibutton with-count js-toggler-target star-button"
        ...
        <li>
          <a href="/twbs/bootstrap/fork" class="minibutton with-count js-toggler-target fork-button lighter tooltipped-n" title="Fork your own copy of twbs/bootstrap to your account" aria-label="Fork your own copy of twbs/bootstrap to your account" rel="nofollow" data-method="post">
            <span class="octicon octicon-repo-forked"></span><span class="text">Fork</span>
          </a>
          <a href="/twbs/bootstrap/network" class="social-count">24,872</a>
        </li>
...
<a href="/twbs/bootstrap/blob/8e568a8e3652e48e6af23c1aedce2b63dbd2fa9e/docs/assets/js/ie-emulation-modes-warning.js" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/twbs/bootstrap/blob/apple-touch-icon/docs/assets/js/ie-emulation-modes-warning.js"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/twbs/bootstrap/blob/docs_zeroclipboard/docs/assets/js/ie-emulation-modes-warning.js"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/twbs/bootstrap/blob/fix-13386/docs/assets/js/ie-emulation-modes-warning.js"
                 data-name="fix-13386"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/twbs/bootstrap/blob/icon_paths/docs/assets/js/ie-emulation-modes-warning.js"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/twbs/bootstrap/blob/impl-13342/docs/assets/js/ie-emulation-modes-warning.js"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/twbs/bootstrap/blob/maybe-fix-12364/docs/assets/js/ie-emulation-modes-warning.js"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/twbs/bootstrap/blob/mo-classes-less-problems/docs/assets/js/ie-emulation-modes-warning.js"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/twbs/bootstrap/blob/pr-13589/docs/assets/js/ie-emulation-modes-warning.js"
                 data-name="pr-13589"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/twbs/bootstrap/blob/pr-13593/docs/assets/js/ie-emulation-modes-warning.js"
                 data-name="pr-13593"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/twbs/bootstrap/blob/reinstate-13470/docs/assets/js/ie-emulation-modes-warning.js"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/twbs/bootstrap/blob/xhmikosr-js-style/docs/assets/js/ie-emulation-modes-warning.js"
    ...
    <div class="meta clearfix">
      ...
      <div class="actions">
        <div class="button-group">
          ...
          <a href="/twbs/bootstrap/raw/master/docs/assets/js/ie-emulation-modes-warning.js" class="button minibutton " id="raw-url">Raw</a>
            <a href="/twbs/bootstrap/blame/master/docs/assets/js/ie-emulation-modes-warning.js" class="button minibutton js-update-url-with-hash">Blame</a>
          <a href="/twbs/bootstrap/commits/master/docs/assets/js/ie-emulation-modes-warning.js" class="button minibutton " rel="nofollow">History</a>
        </div><!-- /.button-group -->
...
<span id="L51" rel="#L51">51</span>
           ...
           <td class="blob-line-code"><div class="code-body highlight"><pre><div class='line' id='LC1'><span class="c1">// NOTICE!! DO NOT USE ANY OF THIS JAVASCRIPT</span></div><div class='line' id='LC2'><span class="c1">// IT&#39;S JUST JUNK FOR OUR DOCS!</span></div><div class='line' id='LC3'><span class="c1">// ++++++++++++++++++++++++++++++++++++++++++</span></div><div class='line' id='LC4'><span class="cm">/*!</span></div><div class='line' id='LC5'><span class="cm"> * Copyright 2014 Twitter, Inc.</span></div><div class='line' id='LC6'><span class="cm"> *</span></div><div class='line' id='LC7'><span class="cm"> * Licensed under the Creative Commons Attribution 3.0 Unported License. For</span></div><div class='line' id='LC8'><span class="cm"> * details, see http://creativecommons.org/licenses/by/3.0/.</span></div><div class='line' id='LC9'><span class="cm"> */</span></div><div class='line' id='LC10'><span class="c1">// Intended to prevent false-positive bug reports about Bootstrap not working properly in old versions of IE due to folks testing using IE&#39;s unreliable emulation modes.</span></div><div class='line' id='LC11'><span class="p">(</span><span class="kd">function</span> <span class="p">()</span> <span class="p">{</span></div><div class='line' id='LC12'>&nbsp;&nbsp;<span class="s1">&#39;use strict&#39;</span><span class="p">;</span></div><div class='line' id='LC13'><br/></div><div class='line' id='LC14'>&nbsp;&nbsp;<span class="kd">function</span> <span class="nx">emulatedIEMajorVersion</span><span class="p">()</span> <span class="p">{</span></div><div class='line' id='LC15'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="kd">var</span> <span class="nx">groups</span> <span class="o">=</span> <span class="sr">/MSIE ([0-9.]+)/</span><span class="p">.</span><span class="nx">exec</span><span class="p">(</span><span class="nb">window</span><span class="p">.</span><span class="nx">navigator</span><span class="p">.</span><span class="nx">userAgent</span><span class="p">)</span></div><div class='line' id='LC16'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">if</span> <span class="p">(</span><span class="nx">groups</span> <span class="o">===</span> <span class="kc">null</span><span class="p">)</span> <span class="p">{</span></div><div class='line' id='LC17'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">return</span> <span class="kc">null</span></div><div class='line' id='LC18'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="p">}</span></div><div class='line' id='LC19'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="kd">var</span> <span class="nx">ieVersionNum</span> <span class="o">=</span> <span class="nb">parseInt</span><span class="p">(</span><span class="nx">groups</span><span class="p">[</span><span class="mi">1</span><span class="p">],</span> <span class="mi">10</span><span class="p">)</span></div><div class='line' id='LC20'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="kd">var</span> <span class="nx">ieMajorVersion</span> <span class="o">=</span> <span class="nb">Math</span><span class="p">.</span><span class="nx">floor</span><span class="p">(</span><span class="nx">ieVersionNum</span><span class="p">)</span></div><div class='line' id='LC21'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">return</span> <span class="nx">ieMajorVersion</span></div><div class='line' id='LC22'>&nbsp;&nbsp;<span class="p">}</span></div><div class='line' id='LC23'><br/></div><div class='line' id='LC24'>&nbsp;&nbsp;<span class="kd">function</span> <span class="nx">actualNonEmulatedIEMajorVersion</span><span class="p">()</span> <span class="p">{</span></div><div class='line' id='LC25'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="c1">// Detects the actual version of IE in use, even if it&#39;s in an older-IE emulation mode.</span></div><div class='line' id='LC26'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="c1">// IE JavaScript conditional compilation docs: http://msdn.microsoft.com/en-us/library/ie/121hztk3(v=vs.94).aspx</span></div><div class='line' id='LC27'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="c1">// @cc_on docs: http://msdn.microsoft.com/en-us/library/ie/8ka90k2e(v=vs.94).aspx</span></div><div class='line' id='LC28'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="kd">var</span> <span class="nx">jscriptVersion</span> <span class="o">=</span> <span class="k">new</span> <span class="nb">Function</span><span class="p">(</span><span class="s1">&#39;/*@cc_on return @_jscript_version; @*/&#39;</span><span class="p">)()</span> <span class="c1">// jshint ignore:line</span></div><div class='line' id='LC29'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">if</span> <span class="p">(</span><span class="nx">jscriptVersion</span> <span class="o">===</span> <span class="kc">undefined</span><span class="p">)</span> <span class="p">{</span></div><div class='line' id='LC30'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">return</span> <span class="mi">11</span> <span class="c1">// IE11+ not in emulation mode</span></div><div class='line' id='LC31'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="p">}</span></div><div class='line' id='LC32'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">if</span> <span class="p">(</span><span class="nx">jscriptVersion</span> <span class="o">&lt;</span> <span class="mi">9</span><span class="p">)</span> <span class="p">{</span></div><div class='line' id='LC33'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">return</span> <span class="mi">8</span> <span class="c1">// IE8 (or lower; haven&#39;t tested on IE&lt;8)</span></div><div class='line' id='LC34'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="p">}</span></div><div class='line' id='LC35'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">return</span> <span class="nx">jscriptVersion</span> <span class="c1">// IE9 or IE10 in any mode, or IE11 in non-IE11 mode</span></div><div class='line' id='LC36'>&nbsp;&nbsp;<span class="p">}</span></div><div class='line' id='LC37'><br/></div><div class='line' id='LC38'>&nbsp;&nbsp;<span class="kd">var</span> <span class="nx">ua</span> <span class="o">=</span> <span class="nb">window</span><span class="p">.</span><span class="nx">navigator</span><span class="p">.</span><span class="nx">userAgent</span></div><div class='line' id='LC39'>&nbsp;&nbsp;<span class="k">if</span> <span class="p">(</span><span class="nx">ua</span><span class="p">.</span><span class="nx">indexOf</span><span class="p">(</span><span class="s1">&#39;Opera&#39;</span><span class="p">)</span> <span class="o">&gt;</span> <span class="o">-</span><span class="mi">1</span> <span class="o">||</span> <span class="nx">ua</span><span class="p">.</span><span class="nx">indexOf</span><span class="p">(</span><span class="s1">&#39;Presto&#39;</span><span class="p">)</span> <span class="o">&gt;</span> <span class="o">-</span><span class="mi">1</span><span class="p">)</span> <span class="p">{</span></div><div class='line' id='LC40'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">return</span> <span class="c1">// Opera, which might pretend to be IE</span></div><div class='line' id='LC41'>&nbsp;&nbsp;<span class="p">}</span></div><div class='line' id='LC42'>&nbsp;&nbsp;<span class="kd">var</span> <span class="nx">emulated</span> <span class="o">=</span> <span class="nx">emulatedIEMajorVersion</span><span class="p">()</span></div><div class='line' id='LC43'>&nbsp;&nbsp;<span class="k">if</span> <span class="p">(</span><span class="nx">emulated</span> <span class="o">===</span> <span class="kc">null</span><span class="p">)</span> <span class="p">{</span></div><div class='line' id='LC44'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">return</span> <span class="c1">// Not IE</span></div><div class='line' id='LC45'>&nbsp;&nbsp;<span class="p">}</span></div><div class='line' id='LC46'>&nbsp;&nbsp;<span class="kd">var</span> <span class="nx">nonEmulated</span> <span class="o">=</span> <span class="nx">actualNonEmulatedIEMajorVersion</span><span class="p">()</span></div><div class='line' id='LC47'><br/></div><div class='line' id='LC48'>&nbsp;&nbsp;<span class="k">if</span> <span class="p">(</span><span class="nx">emulated</span> <span class="o">!==</span> <span class="nx">nonEmulated</span><span class="p">)</span> <span class="p">{</span></div><div class='line' id='LC49'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="nb">window</span><span class="p">.</span><span class="nx">alert</span><span class="p">(</span><span class="s1">&#39;WARNING: You appear to be using IE&#39;</span> <span class="o">+</span> <span class="nx">nonEmulated</span> <span class="o">+</span> <span class="s1">&#39; in IE&#39;</span> <span class="o">+</span> <span class="nx">emulated</span> <span class="o">+</span> <span class="s1">&#39; emulation mode.\nIE emulation modes can behave significantly differently from ACTUAL older versions of IE.\nPLEASE DON\&#39;T FILE BOOTSTRAP BUGS based on testing in IE emulation modes!&#39;</span><span class="p">)</span></div><div class='line' id='LC50'>&nbsp;&nbsp;<span class="p">}</span></div><div class='line' id='LC51'><span class="p">})();</span></div></pre></div></td>
         </tr>
       </table>
  </div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2014 <span title="0.07097s from github-fe121-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
